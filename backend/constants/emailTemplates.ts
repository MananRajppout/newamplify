...
export const verificationEmailTemplate = (name: string, token: string): string => `
  ...
  <p><a href="${config.frontend_base_url}/verify-account?token=${token}">Verify Your Account</a></p>
  <p style="color: blue;">${config.frontend_base_url}/verify-account?token=${token}</p>
...
export const resetPasswordEmailTemplate = (name: string, token: string): string => `
  ...
  <p>
    <a href="${config.frontend_base_url}/reset-password?token=${token}">
      Reset Your Password
    </a>
  </p>
  <p style="color: blue;">${config.frontend_base_url}/reset-password?token=${token}</p>
